...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 17, 2022 at 07:30 PM
...
CREATE TABLE `events` (
  ...
  `going` varchar(255) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `events` (`id`, `heading`, `content`, `event_image`, `status`, `created_at`, `event_date`, `going`) VALUES
(1, 'Workshop', 'This is our test content', 'events.jpeg', 1, '2022-08-28 05:36:19', '2022-09-07', '1');
...
INSERT INTO `events_participant` (`participant_id`, `user_id`, `event_id`, `status`) VALUES
(36, '011191117', '1', '1');
...
('011191156', '011191117', '0000-00-00 00:00:00.000000'),
('011191156', '011191117', '0000-00-00 00:00:00.000000');
...
INSERT INTO `logistic` (`logistic_id`, `logistic_name`, `logistic_date`, `logistic_details`, `status`, `created_at`) VALUES
(5, 'Party', '2022-09-18', 'Chair lagbe', '', '2022-09-17 16:35:16');
...
INSERT INTO `members` (`m_id`, `user_id`, `club_id`, `full_name`, `uni_id`, `mem_image`, `trns_id`, `status`) VALUES
(3, '011191117', '011191117', 'Shahriar', '011191212', '011191156.jpg', '21fsda2f1', 1),
(4, '011191117', '011191117', 'Rafi', 'fsad', '011191130.jpg', '21fsda2f1', 0);
...
CREATE TABLE `membership` (
  ...
  `recrut_img` varchar(255) NOT NULL,
...
INSERT INTO `membership` (`mem_id`, `heading`, `user_id`, `club_id`, `payment`, `description`, `recrut_img`, `join_date`) VALUES
(7, '2022 Fall ', '', '011191117', '350', 'test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test test ', '56936289_2319870071584694_6927666189841727488_n.jpg', '2022-09-20');
...
('011191117', 'club', 'UIU Robotics Club', 'srahman191117@bscse.uiu.ac.bd', '011191172', 'CSE', 'robodp.jpg', 'robobanner.jpg', '', '', '', '', ''),
('011191130', 'user', 'Ahmed Rafi Hasan', 'ahasan191130@bscse.uiu.ac.bd', '011191172', 'CSE', '011191130.jpg', '011191130.jpg', '', '', '', '', ''),
('011191156', 'user', 'Shahariar Tasin Rifat', 'srifat191156@bscse.uiu.ac.bd', '011191172', 'CSE', '011191156.jpg', '011191156.jpg', 'Cholo na boshundhora jai :)', 'https://www.facebook.com/Shahariar.Tasin.Rifat', 'linkedin.com/rifat', 'github.com/rifat', 'rifat.com'),
...
('DeptCSE', 'dsa', 'Department of Computer Science and Engineering', 'cse.uiu.ac.bd', '011191172', '', 'dsadp.jpg', 'dsacover.jpg', '', '', '', '', '');
...
--
ALTER TABLE `logistic`
  MODIFY `logistic_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
