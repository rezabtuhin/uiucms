                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-8 no-pd">
                                <div class="main-ws-sec">
                                    ...
                                    <div class="product-feed-tab" id="saved-jobs">
                                        <!-- <ul class="nav nav-tabs" id="myTab">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="creat-event" data-toggle="tab" href="#saved" role="tab" aria-controls="profile" aria-selected="false">Creat event</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="event-list" data-toggle="tab" href="#saved" role="tab" aria-controls="profile" aria-selected="false">Event list</a>
                                            </li>
                                        </ul> -->
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane fade show active" id="mange" role="tabpanel" aria-labelledby="mange-tab">
                                                <?php
                                                $sql0 = "SELECT * FROM events ORDER BY created_at DESC";
                                                ...
                                                ?>
                                                            <div class="posts-bar">
                                                                <div class="post-bar bgclr">
                                                                    <img class="event_images" src="images/events/<?php echo $data['event_image']; ?>" alt="">
                                    ...
                                    <div class="product-feed-tab current" id="feed-dd">
                                        ...
                                        <?php $sql = "SELECT * FROM post WHERE user_id = '$user' ORDER BY time DESC";
                                                    ...
                                                    <div class="posty">
                                                        <div class="post-bar no-margin">
                                                            <div class="post_topbar">
                                                                <div class="usy-dt">
                                                                    <?php
                                                                        $sql66 = "SELECT * FROM users WHERE id = '$user'";
                                                                        $res66 = mysqli_query($con,$sql66);
                                                                        while ($rows99 = mysqli_fetch_assoc($res66)){
                                                                            ?>
                                                                                <img src="./images/pro_pic/<?php echo $rows99['profile_pic'] ?>" alt="" width=45>
                                                                                <div class="usy-name">
                                                                                    <h3><?php echo $rows99["name"]; ?></h3>
                                                                            <?php
                                                                        }
                                                                    ?>
                                                        ...
                                                        <div class="comment-section">
                                                            ...
                                                            <div class="post-comment">
                                                                <div class="comment_box">
                                                                    ...
                                                                    ?>
                                                                        <script>
                                                                            window.location.href = "dsa_profile.php";
                                                                        </script>
                                                                    <?php
                                                                    }
                                                                    ?>
                                ...
                                <div class="inp-field">
                                    ...
                                    <div class="product-feed-tab" id="create-club">
                                        <div class="user-profile-ov">
                                            ...
                                            if (isset($_POST['create_club'])) {
                                                ...
                                                $folder = "images/pro_pic/" . $profile_pic;

                                                move_uploaded_file($tempname, $folder);

                                                $cover_pic = $_FILES["cover_pic"]["name"];
                                                $tempname = $_FILES["cover_pic"]["tmp_name"];
                                                $folder = "images/cover_pic/" . $cover_pic;
                                                ...
                                                mysqli_query($con, "insert into users (id,role,name,email,pass,profile_pic,cover_pic,personal_web)
											values ('$username','$role','$name','$email','$pass','$profile_pic','$cover_pic','$personal_web')") or die(mysqli_error($con));
                                            ?>
                                                <script>
                                                    window.location.href = "admin_profile.php?msg=created";
                                                </script>
                                            <?php
                                            }
                                            ?>
                                            <div class="acc-setting">
                                                <form method="post" enctype="multipart/form-data">
                                                    ...
                                                    <div class="cp-field">
                                                        <div>
                                                            <input type="text" name="name" placeholder="Enter club name">
                                                        </div>
                                                    </div>
                                                    <div class="cp-field">
                                                        <div>
                                                    ...
                                                    <div class="cp-field">
                                                        <div>
                                                            <input type="password" name="pass" placeholder="Enter passowrd">
                                                        </div>
                                                    </div>
                                                    <div class="cp-field">
                                                        <p>Profile Picture:</p>
                                                    ...
                                                    <div class="cp-field">
                                                        <div>
                                                            <input type="text" name="personal_web" placeholder="Enter website link">
                                                        </div>
                                                    </div>
                                                    <div class="save-stngs pd3">
                                                        <ul>
                                                            <li><button type="submit" name="create_club">Create</button></li>
                                                        </ul>
                                                    </div>
                                                </form>
                                            </div>
